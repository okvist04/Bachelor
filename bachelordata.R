...
plot(return, ylab = "Returns (USD)", xlab = "Years", main = "Simple Net Returns ") #The time series is definitely not stationary
acf(return) #Slow decrease suggest good idea to difference the log-prices.
